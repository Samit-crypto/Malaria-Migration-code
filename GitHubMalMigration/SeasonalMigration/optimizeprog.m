...
if runningPlot==1
[goodofit1, Error1, absError1] = gfit(MalNewCase,TP,'9'); % Gfit has been modified to get Error1, and absError1
end

AICc = 2*q+156*log(Error1)

XX = [goodofit1, Error1, absError1];
disp(XX)
...
AnlTP = reshape(TP,12,13);
AvgAnlTP = mean(AnlTP,2);

AnlMalCase = reshape(MalNewCase,12,13);
AvgAnlCase = mean(AnlMalCase,2);

figure(111)
plot(1:12,AvgAnlCase,1:12,AvgAnlTP,'r');
